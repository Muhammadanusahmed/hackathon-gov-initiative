        ...
        <div className='bg-black text-white min-h-screen flex items-center justify-center p-8'>
          <div className='container w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8'>
            ...
            <div className='flex flex-col items-center lg:items-start lg:justify-center'>
              <h2
                className='text-[#FF9F0D] font-GreatVibes text-lg mb-4'   
              >
                About us
              </h2>
      ...
      <section>
        <div className='bg-black text-white min-h-screen'>
          ...
          <div className='flex flex-col container w-full mx-auto items-center py-10'>
            <h1
              className='text-4xl font-GreatVibes font-bold text-[#FF9F0D]'
              ...
              <div className='flex justify-start  mt-8'>
                <div className='text-center'>
                  <div className='bg-[#FF9F0D] m-4 p-4 rounded-md'>
                    <img src='/icons/Hamburger.png' alt='hamburger' className=' p-2 text-5xl' />
                  </div>
                  <p className='mt-2'>Fast Food</p>
                </div>
                <div className='text-center'>
                  <div className='bg-[#FF9F0D]  m-4 p-4 rounded-md'>
                    <img src='/icons/Cookie.png' alt='cookie' className=' p-2 text-5xl' />
                  </div>
                  <p className='mt-2'>Lunch</p>
                </div>
                <div className='text-center'>
                  <div className='bg-[#FF9F0D]  m-4 p-4 rounded-md'>
                    <img src='/icons/Wine.png' alt='wine' className=' p-2 text-5xl' />
                  </div>
            ...
            <div className='flex flex-wrap justify-center items-center  p-4 rounded-lg w-full max-w-4xl mx-auto sm:p-8'>
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4 w-full'>
                <div className='text-center text-white flex flex-col items-center'>
                  <img src='/icons/ChefHead.png' alt='ChefHead' className='text-6xl text-[#FF9F0D] mb-4' />
                  <h3 className='text-lg'>Professional Chefs</h3>
                  <p className='text-3xl font-bold'>420</p>
                </div>

                <div className='text-center text-white flex flex-col items-center'>
                  <img src='/icons/Burger.png' alt='Burger' className='text-6xl text-[#FF9F0D] mb-4' />
                  <h3 className='text-lg'>Items Of Food</h3>
                  <p className='text-3xl font-bold'>320</p>
                </div>

                <div className='text-center text-white flex flex-col items-center'>
                  <img src='/icons/Spoon.png' alt="spoon" className='text-6xl text-[#FF9F0D] mb-4' />
                  <h3 className='text-lg'>Years Of Experienced</h3>
                  <p className='text-3xl font-bold'>30+</p>
                </div>

                <div className='text-center text-white flex flex-col items-center'>
                  <img src='/icons/Pizza.png' alt='pizza' className='text-6xl text-[#FF9F0D] mb-4' />
                ...
                <div className='p-6'>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <div className='flex space-x-2 text-[#FF9F0D]'>
                      <img src='/icons/ThumbsUp.png' alt="thumsup" className='text-white' />
                      <img src='/icons/ChatDots.png' alt="comment" className='text-[#FF9F0D]' />
                      <img src='/icons/ShareNetwork.png' alt='share' className='text-white' />
                    </div>
                  </div>
                </div>
              </div>
